...
The final, published manuscript is available from the Statistics in Medicine website: https://doi.org/10.1002/sim.8309

A pre-prints history is available on [arXiv](https://arxiv.org/abs/1810.08140); please get in touch via [Twitter](https://twitter.com/ellessenne) or [e-mail](mailto:ag475@leicester.ac.uk?subject=Preprint: Impact of Model Misspecification in Shared Frailty Survival Models) if you have any comment.
